...
parser.add_argument('--prikey', type=str, default='AWTUejAcdPLPHZShgAEZrMxtvc5ChayCxqVDzkEc42xP')
...
def mint():
    user = pxsol.wallet.Wallet(pxsol.core.PriKey.base58_decode(args.prikey))
    assert user.pubkey.base58() == 'AnpiWSzz4YWsiSA8xzYkCPEhL7zLC4Yx1ozU8wLa213k'
    prog_pubkey = pxsol.core.PubKey.base58_decode(info_load('pubkey'))
